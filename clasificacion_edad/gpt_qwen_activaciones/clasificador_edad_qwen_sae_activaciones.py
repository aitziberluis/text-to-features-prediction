...
ACTIVATIONS_DIR = "/hdd/aitziber.l/activaciones_qwen_sae_edad"
# rangos de edad
...
OUTPUT_DIR = "modelos/edad_qwen_sae_activaciones"
            ...
            while start < n:
                ...
                while True:
                    ...
                    try:
                        ...
                        last_token_arr[start:end] = np.nan_to_num(last_pooled.float().cpu().numpy(), nan=0.0, posinf=0.0, neginf=0.0).astype(FEATURES_DTYPE, copy=False)
                        mean_token_arr[start:end] = np.nan_to_num(mean_pooled.float().cpu().numpy(), nan=0.0, posinf=0.0, neginf=0.0).astype(FEATURES_DTYPE, copy=False)
                        break
