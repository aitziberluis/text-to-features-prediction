...
ACTIVATIONS_DIR = "/hdd/aitziber.l/activaciones_qwen_genero"
#splits
TEST_SIZE = 0.15
EVAL_SIZE = 0.15
RANDOM_STATE = 42
...
# output
OUTPUT_DIR = "modelos/genero_qwen_activaciones"
...
def main():
    ...
    for pooling_name in COMMENT_POOLINGS:
        ...
        for bal_cfg in BALANCE_CONFIGS:
            if bal_cfg["name"] == "undersampling":
                ...
                clf, metrics = entrenar_comentario(X_train=X_tr, y_train=y_train_c,X_eval=X_ev, y_eval=y_eval_c,female_w=bal_cfg["female_w"], male_w=bal_cfg["male_w"],pooling_name=pooling_name, balance_name=bal_cfg["name"],scaler=scaler,
                )
    ...
    with open(summary_path, "w", encoding="utf-8") as f:
        json.dump({
            ...
            "best_run_on_eval": {"name": best_run,"level": best_artifact["level"],"pooling": best_artifact["pooling"],"eval_metrics": best_eval_metrics,"test_metrics": best_test_metrics,
            },
            "best_per_level": {
                level: (
                    None
