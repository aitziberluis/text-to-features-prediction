"""
Clasificador de INTROVERTED usando activaciones directas de GPT-2 (NO SAE).
...
ACTIVATIONS_DIR = f"/hdd/aitziber.l/activaciones_qwen_{TRAIT_NAME}"
...
# output
OUTPUT_DIR = f"modelos/{TRAIT_NAME}_qwen_activaciones"
