...
def main() -> None:
    config = SaeInterpretabilityConfig(
        task_name="intuitive_qwen",
        dataset_kind="mbti",
        splits_dir="data/splits_intuitive",
        output_dir="modelos/intuitive_qwen_sae_interpretabilidad",
        class_names=("0", "1"),
        mbti_trait="intuitive",
        sae_results_path="modelos/intuitive_qwen_sae_activaciones/resultados_resumen.json",
    )
